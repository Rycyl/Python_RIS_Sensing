...
if __name__ == "__main__":
    ...
    num_of_possitions = 18 #Set how many possitions will be measured
    ...
    ref_carriers = np.linspace(0, 789, 10, dtype=np.int16)
    ...
    while True:
        ...
        if n == num_of_possitions or n > num_of_possitions:
            ...
            sleep(10)
            if ref:
                new_ref_files = [os.path.basename(file).split("_17_Jun")[0] for file in ref_files]
